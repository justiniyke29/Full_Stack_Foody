...
const Footer = () => {
  return (
    <div className="w-full bg-slate-500 flex flex-col items-center text-sm relative bottom-0">
      <div className="grid h-auto w-full lg:w-3/4 sm:w-full  gap-y-8 lg:gap-x-16 sm:grid-cols-2 md:grid-cols-4 text-white p-4 md:p-8">
        ...
        <div className="flex flex-col gap-y-4 md:items-center">
          ...
          <div className="flex text-white gap-x-2">
            <FaFacebook />
            <a href="https://twitter.com/sazzy_io">
              <FaTwitter />
            </a>
            <a href="https://www.instagram.com/still_doing_the_most_/">
              <FaInstagram />
            </a>
            <a href="https://www.linkedin.com/in/idahosa-joshua/">
              {" "}
              <FaLinkedin />
            </a>
          </div>
        ...
        <div>
          <h5 className="font-bold text-lg py-2">Support</h5>
          <div className="flex flex-col gap-y-3">
            <p>FAQ</p>
        ...
        {/* info section */}
        <div>
          <h5 className="font-bold text-lg py-2">Info</h5>
          <div className="flex flex-col gap-y-3">
            <p>Dates</p>
            <p>Parties</p>
            <p>Birthdays</p>
      ...
      <span className="text-white text-[12px] flex justify-center py-2 text-center">
        {" "}
        &copy; Made with 💖 by Anyanwu Justin. All right Reserved{" "}
      </span>
    </div>
  );
};
