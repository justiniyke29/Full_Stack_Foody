      ...
      <header className="h-auto w-screen bg-[#fffdfd] flex lg:px-28 flex-col justify-center z-10  mb-3 sticky top-0 ">
        ...
        >
          <div className="w-3/5">
            {/* Logo goes here */}
            <Link to="/">
              <motion.div className="flex justify-start items-center font-semibold">
                <img src={logo} alt="Logo" className="w-12 h-12" />{" "}
                <span className="text-2xl tracking-wide text-slate-700">
                  <span className=" font-serif">C</span>
                  <span className="text-black font-serif">i</span>
                  <span className="text-black font-serif">t</span>
            ...
            >
              <NavLink to="/">
                <motion.li
                  ...
                  className={`relative flex items-center gap-x-2 (navData) => (navData.isActive ? 'active' : '')`}
                >
                  Home <FaHome />
                </motion.li>
              </NavLink>
              ...
              <NavLink to="/aboutus">
                <motion.li
                  ...
                  className={`relative  flex items-center gap-x-2  (navData) => (navData.isActive ? 'active' : '')`}
                >
                  About Us <SiInformatica />{" "}
                </motion.li>
              </NavLink>
              {!User && (
                <li
                  className="hover:bg-slate-600 hover:font-semi-bold transition-all duration-300 ease-in-out hover:text-slate-100 border bg-slate-500 hover:shadow-lg cursor-pointer  text-slate-50 rounded-lg px-2 p-1 min-w-[74px]"
          ...
          <div className="flex  transition-all ease-in-out duration-1000">
            <div className="flex justify-center items-center box-border gap-3 min-w-[88px]">
              <motion.div
                ...
                className="text-xl  relative flex justify-center cursor-pointer -left-2 items-center"
              >
                <IoMdCart />{" "}
                <span className="text-slate-100  absolute -top-2 -right-2 text-[10px] p-1  bg-red-500 rounded-full w-4 h-4 flex font-bold items-center justify-center">
                  {cartItems.length}
                </span>
              </motion.div>
              ...
              {!User && (
                ...
                >
                  <motion.img
                    src={Avatar}
                    whileTap={{ scale: 0.8 }}
                    className="w-9 h-9 cursor-pointer hover:border-2 rounded-full hover:shadow-lg  border-cyan-600 "
                    alt="Avatar"
                  />
                  {openMenu ? (
                    <BiChevronDown className="min-w-[12px]" />
                  ) : (
                    <BiChevronUp className="min-w-[12px]" />
                  )}
                </div>
              )}
              <div>
                {!openMenu && !User && (
                  ...
                  >
                    <p
                      className="border bg-slate-100 rounded flex justify-center items-center  text-sm p-1 px-1 absolute right-5  w-1/6 transition-all ease-in-out duration-600 font-semibold m-2  mt-8"
                      onClick={handleLogin}
                    >
                      <p className=" flex justify-center rounded hover:bg-slate-300 cursor-pointer p-1 items-center w-full">
                        Login{" "}
                        <span className="px-1">
                          <TbLogin />
                        </span>{" "}
              ...
              {User && (
                ...
                >
                  <motion.img
                    src={User.providerData[0].photoURL || Avatar}
                    whileTap={{ scale: 0.7 }}
                    className="w-8 h-8 cursor-pointer hover:border-2 rounded-full hover:shadow-lg  border-cyan-600 "
                    alt=""
                  />
                  {openMenu ? (
                    <BiChevronDown className="min-w-[12px]" />
              ...
              <div>
                {!openMenu && User && (
                  ...
                  >
                    {User && User.email === "justiniyke1995@gmail.com" && (
                      <p className="flex m-1 justify-center p-1 rounded items-center cursor-pointer hover:bg-slate-300">
                        New Item{" "}
                        <span className="mx-1">
                          <IoIosAdd />
                        </span>{" "}
                    ...
                    <hr />
                    <p
                      className="flex m-1 items-center justify-center  p-1 rounded cursor-pointer hover:bg-slate-300"
                      onClick={LogOut}
                    >
                      Logout{" "}
                      <span className="mx-2">
              ...
              <div className='text-xs text-emerald-900" overflow-hidden max-w-[134px] max-h-[20px] flex justify-center  absolute top-12 p-1 font-semibold right-18 '>
                ...
                {User && (
                  <p className="z-99">
                    {User.displayName
                      ? "Hi! " + User.displayName.slice(0, 9) + "."
                      : "Hi! " + User.email.slice(0, 15) + "."}
                  </p>
                )}
        ...
        <div className="md:hidden flex justify-between w-screen p-5 py- relative z-20">
          ...
          >
            <Link to="/cartItems3qPzZ26PeuhwEyCdgWWBXK2vGNF7">
              <IoMdCart />{" "}
              <span className="text-white absolute top-0.5 -right-2 text-[10px] p-1  bg-red-500 shadow-lg rounded-full w-4 h-4 flex font-bold items-center justify-center">
                {cartItems.length}
              </span>
            </Link>
          </motion.div>
          ...
          <div className="flex">
            {!User && (
              <div
                className="flex justify-center relative cursor-pointer items-center"
                onClick={RemoveNav}
              >
                <motion.img
                  src={Avatar}
                  whileTap={{ scale: 0.8 }}
                  className="w-9 h-9 cursor-pointer hover:border-2 rounded-full hover:shadow-lg  border-cyan-600 z-10"
                  alt="Avatar"
                />
                {openMenu ? (
                  <BiChevronDown className="min-w-[12px] z-99" />
                ) : (
                  <BiChevronUp className="z-10" />
                )}
              </div>
            )}
            <div>
              ...
              <AnimatePresence>
                {!openMenu && !User && (
                  <motion.ul
                    ...
                    onMouseOut={RemoveNav}
                  >
                    <li
                      className=" flex justify-center items-center gap-x-3 text-sm p-8 px-2 transition-all rounded ease-in-out duration-600 hover:bg-slate-200 cursor-pointer hover:rounded   hover:border-gray-400 "
                      onClick={handleLogin}
                    >
                      {" "}
                      <TbLogin />
                    ...
                    <div
                      onClick={RemoveNav}
                      className="absolute cursor-pointer top-5 left-6 text-4xl rotate-45 font-light border-2 rounded-full w-10 h-10 flex justify-center items-center border-slate-400 hover:border-slate-700 hover:text-slate-300 bg-slate-400"
                    >
                      +
                    </div>
                  </motion.ul>
                ...
                {!openMenu && User && (
                  ...
                  >
                    {User && User.email === "justiniyke1995@gmail.com" && (
                      <li
                        onClick={RemoveNav}
                        className="flex m-1 justify-center p-8 rounded items-center cursor-pointer hover:bg-slate-300"
                      >
                        New Item
                        <span className="mx-1">
                          <IoIosAdd />
                    ...
                    <NavLink to="/">
                      <li
                        onClick={RemoveNav}
                        className={`relative flex justify-center m-1 items-center gap-x-4  text-sm p-8 px-2 transition-all rounded ease-in-out duration-600 hover:bg-slate-300 cursor-pointer hover:border-gray-400 (nav) => (nav.isActive ? 'activeLink' : '')`}
                      >
                        <FaHome /> Home
                      </li>
                    </NavLink>
            ...
            (nav) => (nav.isActive ? 'activeLink' : '')`}
                    ...
                    <li
                      className="flex m-1 items-center justify-center p-8 gap-x-3 rounded cursor-pointer hover:bg-slate-300"
                      onClick={LogOut}
                    >
                      {" "}
                      <span>
